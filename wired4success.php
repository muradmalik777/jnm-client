            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-4 col-12">
                    <div class="bg-white pinside30 mb30 highlight-outline outline">
                        <h4>Guided Tutorials</h4>
                        <p>Watch the video lessons in the members area using any device connected to internet. Downloadable "offline" templates and scripts are also included so you can learn on the go. You can spend years collecting all the necessary skills and knowledge alone OR get everything in one convenient place.</p>
                    </div>
                </div>
                <!-- /.features -->
                <!-- features -->
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-4 col-12">
                    <div class="bg-white pinside30 mb30 highlight-outline outline">
                        ...
                        <p>I have multiple staff members on standby to help you with whatever issue you might stumble upon” available 24/7. As a member of the Wired4Success you'll get priority access to my team. </p>
                    </div>
                </div>
                <!-- /.features -->
                <!-- features -->
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-4 col-12">
                    <div class="bg-white pinside30 mb30 highlight-outline outline">
                        ...
                        <p>Surround yourself with like-minded people in highly-active community. With thousands of people interacting daily, starting a discussion, getting helpful answers, and networking has never been easier. </p>
                    </div>
                </div>
                <!-- /.features -->
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="mb30 text-center section-title">
                        ...
                        <div class="row">
                         ...
                         <a href="signup.php" class="btn btn-default mt40">Sign Up Now</a>
                    </div>
                    <!-- /.section title start-->
                </div>
            </div>
...
<!-- lead-genrator-landing-page.html  19:06:50  -->
</html>
